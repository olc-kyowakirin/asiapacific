        ...
        funcInitHeaderGlobal = function () {
            ...
            funcHeader = function () {
                ...
                $btnSpMenu.removeClass('open').find('img').attr({
                    src: '/asiapacific/share/images/icon_menu_sp_01.png',
                    alt: 'open menu'
                });
                ...
                if (funcCheckSpView(headerBreakPoint)) {
                    ...
                    $btnSpMenu.off('click.SpMenuToggle').on('click.SpMenuToggle', function () {
                        ...
                        if ($self.hasClass('open')) {
                            ...
                            $icon.attr({
                                alt: 'close menu',
                                src: '/asiapacific/share/images/icon_menu_sp_02.png'
                            });
                ...
                for (; dataI < dataLen; dataI++) {
                    ...
                    if (this.listType === 1) {
                        ...
                        if (!dataItem.type || dataItem.type === 'normal') {
                            ...
                            tmpType1 = tmpType1.replace(/{{link}}/g, '<a href="' + dataItem.url + '" target="_blank">' + dataItem.ttl + '<img src="/asiapacific/share/images/icon_link_blank_07.png" alt="Open in new window" class="icon-blank"></a>');
                        } else if (dataItem.type === 'pdf') {
                            tmpType1 = tmpType1.replace(/{{link}}/g, '<a href="' + dataItem.url + '" target="_blank">' + dataItem.ttl + '<img src="/asiapacific/share/images/icon_pdf_blank_05.png" alt="PDF file" class="icon-pdf"></a>');
                        }
                        if (this.test) {
                            testNumberStr = '';
